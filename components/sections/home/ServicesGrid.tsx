        ...
        <section ref={ref} className={`reveal-section w-full bg-[#fff8f5] py-10 md:py-14 is-visible anim-delay-3`}>
            <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-10">
                <div className="mx-auto mb-7 md:mb-10 max-w-xl text-center">
                    ...
                    <h2 className="anim-fade-up anim-delay-1 mt-2 font-serif text-[2rem] sm:text-3xl md:text-4xl text-[#241d16]">{isSq ? "Shërbimet Tona" : "Our Services"}</h2>
                </div>
                ...
                <div className="mx-auto grid max-w-[1020px] grid-cols-2 gap-5 sm:gap-7 md:grid-cols-3 md:gap-7">
                    {services.map((service, index) => (
                        ...
                        >
                                ...
                                <div className="anim-hover-lift relative aspect-[3/3] w-full overflow-hidden bg-[#e8dfd7] md:aspect-[4/5]">
                                    <div className="relative w-[80%] h-[80%] mx-auto mt-[12.5%]">
                                        <Image
                                            ...
                                            alt={getLocalizedServiceName(service, lang)}
                                            fill
                            ...
                            <div className="pt-3">
                                <h3 className="font-serif text-[1.95rem] sm:text-[1.65rem] leading-[1.05] text-[#2f251d]">{getLocalizedServiceName(service, lang)}</h3>
                                <p className="mt-2 text-[13px] sm:text-[11px] leading-[1.65] text-[#6f655b]">
                                    {getLocalizedServiceDescription(service, lang)}
                                </p>
                                <Link
                                ...
                                >
                                    {isSq ? "Shiko Produktet" : "View Products"}
                                </Link>
                            </div>
                        </article>
                    ))}
